...
describe("Address Service", () => {
    ...
    describe("getActiveUserAddresses()", () => {
      ...
      it("should propagate database errors", async () => {
        ...
        await expect(getActiveUserAddresses(mockUserId))
    ...
    describe("getAllUserAddresses()", () => {
      ...
      it("should propagate database errors", async () => {
        ...
        await expect(getAllUserAddresses(mockUserId))
          .rejects.toThrow(errorMessage);
    ...
    describe("getUserAddress()", () => {
      ...
      it("should throw ADDRESS_NOT_FOUND when address doesn't exist", async () => {
        ...
        await expect(getUserAddress(mockUserId, 999))
      ...
      it("should propagate database errors", async () => {
        ...
        await expect(getUserAddress(mockUserId, mockAddressId))
          .rejects.toThrow(errorMessage);
