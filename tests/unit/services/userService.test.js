...
describe("User Service", () => {
  ...
  describe("getUserDetails()", () => {
    it("should return complete user details", async () => {
      ...
      getAllUserAddresses.mockResolvedValue([{ id: 1, city: "Oradea" }]);
      ...
      expect(result).toEqual({
        ...
        addresses: [{ id: 1, city: "Oradea" }],
        orders: [{ id: 101, status: "completed", total_price: 99.99 }],
      });
    ...
    it("should handle user not found", async () => {
      ...
      await expect(getUserDetails(999)).rejects.toThrow("User 999 not found");
    });
  });
});
